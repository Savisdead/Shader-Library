...
public:
    ...
    void insertBefore(string word, string insert)
    {
        ...
        /*
        if (currentFunc.Name.compare("main") == 0)
        {
            word = "End";
        }
        else
        {
            word = currentFunc.Tag;
        }
        */
...
bool openFunc = false;
Function currentFunc("void", "main");
...
public:
    ...
    ShaderBuilder() {
        ...
        params.resize(2);
        params[0].push_back("vec3");
        params[0].push_back("direction");
        params[1].push_back("float");
        params[1].push_back("magnitude");
        
        
        openFunction("int", "add");
        

        newVar("mat4", "longview") = var("view") * 3.0;
        //setVariable(var("model"), var("view") * var("projection"));
        //var("model") = var("view") * var("projection") / var("model");
    ...
    void openFunction(string type, string name ) {
    ...
    void closeFunction(Function func)
    {
